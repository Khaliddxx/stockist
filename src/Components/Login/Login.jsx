      ...
      <div className="box-form login-page">
        <div className="left">
          <div className="overlay">
            <h1>Dear Agent</h1>
            <p>
              Welcome to Bettersmile's Agent Portal. Here, you can purchase orders in bulk, and we will offer storage, <br />fulfillment and delivery for you! We also share our proven methods and strategies for marketing 📈
            </p>
            {/* <span>
        ...
        <div className="right">
          ...
          <p>
            ...
            <a href="/register">Register</a> to enroll,
